...
def raise_for_httperror(resp):
    ...
    Raises:
        ...
        searxng.exceptions.SearxEngineAccessDeniedException: raise when the HTTP status code is 402 or 403.
        searxng.exceptions.SearxEngineTooManyRequestsException: raise when the HTTP status code is 429.
        searxng.exceptions.SearxEngineCaptchaException: raise when if CATPCHA challenge is detected.
    """
