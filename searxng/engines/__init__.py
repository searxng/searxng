...
from searxng import logger, settings
from searxng.data import ENGINES_LANGUAGES
from searxng.network import get
from searxng.utils import load_module, match_language, gen_useragent
...
def set_loggers(engine, engine_name):
    ...
    for module_name, module in sys.modules.items():
        if (
            module_name.startswith("searxng.engines")
            and module_name != "searxng.engines.__init__"
