...
from searxng.utils import match_language, extract_text, eval_xpath, eval_xpath_list, eval_xpath_getindex
from searxng.exceptions import SearxEngineCaptchaException
...
def get_lang_info(params, lang_list, custom_aliases, supported_any_language):
    ...
    :param list lang_list: list of supported languages of the engine
        :py:obj:`ENGINES_LANGUAGES[engine-name] <searxng.data.ENGINES_LANGUAGES>`

    :param dict lang_list: custom aliases for non standard language codes
        (used when calling :py:func:`searxng.utils.match_language`)
    ...
    :returns:
        ...
        language:
            Return value from :py:func:`searxng.utils.match_language`
