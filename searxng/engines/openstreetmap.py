...
from searxng.data import OSM_KEYS_TAGS, CURRENCIES
from searxng.utils import searxng_useragent
from searxng.external_urls import get_external_url
from searxng.engines.wikidata import send_wikidata_query, sparql_string_escape
