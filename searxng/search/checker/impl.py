...
from searxng import network, logger
from searxng.utils import gen_useragent
from searxng.results import ResultContainer
from searxng.search.models import SearchQuery, EngineRef
from searxng.search.processors import EngineProcessor
from searxng.metrics import counter_inc


logger = logger.getChild('searxng.search.checker')
