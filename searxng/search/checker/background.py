...
from searxng import logger, settings, searxng_debug
from searxng.exceptions import SearxSettingsException
from searxng.search.processors import PROCESSORS
from searxng.search.checker import Checker
from searxng.shared import schedule, storage
...
def initialize():
    ...
    if searxng_debug and settings.get('checker', {}).get('off_when_debug', True):
