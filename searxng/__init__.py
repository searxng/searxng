...
import searxng.unixthreadname
import searxng.settings_loader
from searxng.settings_defaults import settings_set_defaults
...
searxng_dir = abspath(dirname(__file__))
searxng_parent_dir = abspath(dirname(dirname(__file__)))
settings, settings_load_message = searxng.settings_loader.load_settings()
...
searxng_debug = settings['general']['debug']
if searxng_debug:
