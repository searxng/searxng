...
CONTAINER_IMAGE_ORGANIZATION=${GITHUB_REPOSITORY_OWNER:-"zhensa"}
CONTAINER_IMAGE_NAME="zhensa"
...
container.build() {
    ...
    (
        ...
        timestamp_zhensa_settings=$(git log -1 --format='%ct' ./zhensa/settings.yml)
        ...
        "$container_engine" $params_build_builder \
            ...
            --build-arg="TIMESTAMP_SETTINGS=$timestamp_zhensa_settings" \
