...
from zhensa import settings, autocomplete, favicons
...
from zhensa.locales import LOCALE_NAMES
...
class PluginsSetting(BooleanChoices):
    ...
    def __init__(self, default_value, plugins: Iterable[zhensa.plugins.Plugin]):
...
class Preferences:
    ...
    def __init__(
        ...
        plugins: zhensa.plugins.PluginStorage,
