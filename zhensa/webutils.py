...
from zhensa import logger, get_setting

from zhensa.engines import DEFAULT_CATEGORY

if TYPE_CHECKING:
    from zhensa.enginelib import Engine
    from zhensa.results import ResultContainer
    from zhensa.search import SearchQuery
    from zhensa.results import UnresponsiveEngine
...
exception_classname_to_text = {
    ...
    'zhensa.exceptions.SearxEngineCaptchaException': gettext("CAPTCHA"),
    'zhensa.exceptions.SearxEngineTooManyRequestsException': gettext("too many requests"),
    'zhensa.exceptions.SearxEngineAccessDeniedException': gettext("access denied"),
    'zhensa.exceptions.SearxEngineAPIException': gettext("server API error"),
    'zhensa.exceptions.SearxEngineXPathException': parsing_error_text,
...
def zhensa_l10n_timespan(dt: datetime) -> str:  # pylint: disable=invalid-name
