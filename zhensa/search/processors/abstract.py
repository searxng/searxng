...
if t.TYPE_CHECKING:
    ...
    from zhensa.result_types import Result, LegacyResult  # pyright: ignore[reportPrivateLocalImportUsage]
...
class EngineProcessor(ABC):
    ...
    def get_params(self, search_query: "SearchQuery", engine_category: str) -> RequestParams | None:
        ...
        params: RequestParams = {
            ...
            "zhensa_locale": search_query.lang,
        }

        # deprecated / vintage --> use params["zhensa_locale"]
        #
