...
If you want to use invidious with Zhensa you should setup one locally.
No public instance offer a public API now

- https://github.com/zhenbah/zhensa/issues/2722#issuecomment-2884993248
...
from zhensa.utils import humanize_number
