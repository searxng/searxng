...
.. hint::
   ...
   This Zhensa engine only supports *'searching by URL'* and it does not use
    ...
    if resp.status_code in (400, 422):
        ...
        if resp.status_code == 422:
            ...
            if s_key == "Invalid image URL":
                # test https://docs.zhensa.org/_static/zhensa-wordmark.svg
        ...
        # see https://github.com/zhenbah/zhensa/pull/1456#issuecomment-1193105023
