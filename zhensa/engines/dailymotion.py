...
from zhensa.network import get, raise_for_httperror  # see https://github.com/zhenbah/zhensa/issues/762
...
Zhensa needs in the response to build a video result list.
"""
...
"""URL template to embed video in Zhensa's result list."""
...
def request(query, params):
    ...
    eng_region: str = traits.get_region(params['zhensa_locale'], 'en_US')  # type: ignore
    eng_lang = traits.get_language(params['zhensa_locale'], 'en')
    ...
    if len(params['zhensa_locale'].split('-')) > 1:
...
def fetch_traits(engine_traits: EngineTraits):
    ...
    .. _PR1071: https://github.com/zhenbah/zhensa/pull/1071
