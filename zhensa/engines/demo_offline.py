...
if t.TYPE_CHECKING:
    from zhensa.search.processors import RequestParams
...
def setup(engine_settings: dict[str, t.Any]) -> bool:
    ...
    For more details see :py:obj:`zhensa.enginelib.Engine.setup`.
    """
...
def init(engine_settings: dict[str, t.Any]) -> bool:  # pylint: disable=unused-argument
    ...
    For more details see :py:obj:`zhensa.enginelib.Engine.init`.
    """
    return True
