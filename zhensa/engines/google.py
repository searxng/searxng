...
def get_google_info(params: "OnlineParams", eng_traits: EngineTraits) -> dict[str, t.Any]:
    ...
    sxng_locale = params.get('zhensa_locale', 'all')
    try:
    ...
    # https://github.com/zhenbah/zhensa/issues/2515#issuecomment-1607150817
    ...
    # locale --> https://github.com/zhenbah/zhensa/issues/2672
    ret_val['params']['cr'] = ''
    ...
    # https://github.com/zhenbah/zhensa/issues/2515#issuecomment-1606294635
    ...
    # - https://github.com/zhenbah/zhensa/pull/1679#issuecomment-1235432746
    # - https://github.com/zhenbah/zhensa/issues/1555
