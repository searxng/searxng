...
from zhensa.engines.peertube import fetch_traits  # pylint: disable=unused-import
from zhensa.engines.peertube import (
...
def request(query, params):
    ...
    # eng_region = traits.get_region(params['zhensa_locale'], 'en_US')
    eng_lang = traits.get_language(params['zhensa_locale'], None)
