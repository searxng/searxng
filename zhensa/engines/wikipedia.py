...
To support Wikipedia's LanguageConverter_, a Zhensa request to Wikipedia uses
:py:obj:`get_wiki_params` and :py:obj:`wiki_lc_locale_variants' in the
:py:obj:`fetch_wikimedia_traits` function.

To test in Zhensa, query for ``!wp 出租車`` with each of the available Chinese
options:
...
.. _PR-2554: https://github.com/zhenbah/zhensa/pull/2554
...
from zhensa import network as _network
...
def request(query, params):
    ...
    _eng_tag, wiki_netloc = get_wiki_params(params['zhensa_locale'], traits)
