...
in Zhensa to get the translations of data such as *"published last week"*.
...
from zhensa.utils import eval_xpath, extract_text, eval_xpath_list, eval_xpath_getindex
from zhensa.locales import language_tag, region_tag
...
verification by a cookie is needed / thats not possible in Zhensa.
"""
...
def request(query, params):
    ...
    engine_region = traits.get_region(params['zhensa_locale'], traits.all_locale)  # type: ignore
    engine_language = traits.get_language(params['zhensa_locale'], 'en')  # type: ignore
