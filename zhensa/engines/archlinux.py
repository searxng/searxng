...
from zhensa.utils import extract_text, eval_xpath_list, eval_xpath_getindex
...
def request(query, params):
    ...
    sxng_lang = params['zhensa_locale'].split('-')[0]
    ...
    if netloc == main_wiki:
        ...
        # - https://github.com/zhenbah/zhensa/issues/4646#issuecomment-2817848019
        params['headers']['User-Agent'] = "Zhensa"
...
def response(resp):
    ...
    sxng_lang = resp.search_params['zhensa_locale'].split('-')[0]
    netloc: str = traits.custom['wiki_netloc'].get(sxng_lang, main_wiki)  # type: ignore
    base_url = 'https://' + netloc + '/index.php?'
