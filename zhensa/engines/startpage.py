...
from zhensa.utils import extr, extract_text, eval_xpath, gen_useragent, html_to_text, humanize_bytes, remove_pua_from_str
...
from zhensa.locales import region_tag
...
def get_sc_code(zhensa_locale, params):
    ...
    try:
        ...
        logger.debug("suspend startpage API --> https://github.com/zhenbah/zhensa/pull/695")
        raise SearxEngineCaptchaException(
...
def request(query, params):
    ...
    """
    engine_region = traits.get_region(params['zhensa_locale'], 'en-US')
    ...
    args = {
        ...
        'cat': startpage_categ,
        't': 'device',
        'sc': get_sc_code(params['zhensa_locale'], params),  # hint: this func needs HTTP headers
...
def fetch_traits(engine_traits: EngineTraits):
    ...
    skip_eng_tags = {
        'english_uk',  # Zhensa lang 'en' already maps to 'english'
    }
