...
from zhensa.locales import get_official_locales, language_tag, region_tag
from zhensa.utils import eval_xpath_list
...
def request(query: str, params: dict):
    ...
    country = traits.get_region(params.get("zhensa_locale"), traits.all_locale)  # type: ignore
    if country:
        args["country"] = country

    language = traits.get_language(params.get("zhensa_locale"), traits.all_locale)  # type: ignore
    if language:
...
def fetch_traits(engine_traits: EngineTraits) -> None:
    ...
    # see https://github.com/zhenbah/zhensa/issues/762
