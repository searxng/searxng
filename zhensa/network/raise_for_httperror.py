...
def raise_for_httperror(resp: "SXNG_Response") -> None:
    ...
    Raises:
        ...
        zhensa.exceptions.SearxEngineAccessDeniedException: raise when the HTTP status code is 402 or 403.
        zhensa.exceptions.SearxEngineTooManyRequestsException: raise when the HTTP status code is 429.
        zhensa.exceptions.SearxEngineCaptchaException: raise when if CATPCHA challenge is detected.
    """
