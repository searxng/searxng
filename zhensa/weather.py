...
from zhensa.cache import ExpireCache, ExpireCacheCfg
from zhensa.extended_types import sxng_request
from zhensa.wikidata_units import convert_to_si, convert_from_si
...
def _get_sxng_locale_tag() -> str:
    ...
    #
    # In principle, Zhensa only has two possible parameters for determining
    ...
    # probably never be available in Zhensa (privacy critical).
    #
    ...
    from zhensa import query
    from zhensa.preferences import ClientPref
