...
the ``settings.yml`` file is already located (``/etc/zhensa``). The file then
...
from zhensa.result_types._base import MainResult, LegacyResult
from zhensa.settings_loader import get_yaml_cfg
