...
class LegacyResult(dict[str, t.Any]):
    """A wrapper around a legacy result item.  The Zhensa core uses this class
    ...
    def __init__(self, *args: t.Any, **kwargs: t.Any):
        ...
        if "answer" in self:
            warnings.warn(
                ...
                f" / use a class from zhensa.result_types.answer",
                DeprecationWarning,
            )
        ...
        if self.template == "keyvalue.html":
            warnings.warn(
                ...
                f" / use a class from zhensa.result_types",
                DeprecationWarning,
            )
