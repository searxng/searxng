        ...
        results.append(
            {
                ...
                'publishedDate': datetime.fromisoformat(counts['published']),
                'metadata': metadata,
            }
        )
    return results
        ...
        results.append(
            {
                ...
                'content': content,
                'thumbnail': thumbnail,
                'publishedDate': datetime.fromisoformat(result['post']['published']),
                'metadata': metadata,
            }
        )
        ...
        results.append(
            {
                ...
                'publishedDate': datetime.fromisoformat(result['comment']['published']),
                'metadata': metadata,
            }
        )
