...
base_url = "https://www.chatnoir.eu"  # alternatively: search.gmx.net
categories = ["general"]
...
api_key = ""
"""You can optionally provide your own API key here. This one will then be used instead of scraping an API key."""

search_index = "cw22"
"""
Search index to browse in. See `the API documentation <https://www.chatnoir.eu/docs/api-general>`_ for a full list.
"""
...
def _obtain_api_key() -> tuple[str, str, str]:
    ...
    # session keys seem to become rate-limited very fast, so only remembering for 1 minute here
