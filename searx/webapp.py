...
{
  if( "写一段" in search_queryquery || "写一个" in search_queryquery || "请问" || search_queryquery || "请给" in search_queryquery || "请你" in search_queryquery  || "请推荐" in search_queryquery || "是谁" in search_queryquery || "能帮忙" in search_queryquery || "介绍一下" in search_queryquery || "为什么" in search_queryquery || "什么是" in search_queryquery || "有什么" in search_queryquery || "怎样" in search_queryquery || "给我" in search_queryquery || "如何" in search_queryquery || "谁是" in search_queryquery || "查询" in search_queryquery || "告诉我" in search_queryquery || "查一下" in search_queryquery || "找一个" in search_queryquery || "什么样" in search_queryquery || "哪个" in search_queryquery || "哪些" in search_queryquery || "哪一个" in search_queryquery || "哪一些" in search_queryquery  || "啥是" in search_queryquery || "为啥" in search_queryquery || "怎么" in search_queryquery)
