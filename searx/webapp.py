...
def stats_open_metrics():
    logger.debug(request.preferences)
    if not (settings['general'].get("enable_metrics") and settings['general'].get("open_metrics")):
        return Response('open metrics is disabled', mimetype='text/plain')
