...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      ...
      dist: {
        files: {
          'js/magi.head.min.js': ['src/js/head/*.js'],
          'js/magi.min.js': [
            'src/js/main/*.js',
    ...
    image: {
      svg4web: {
        ...
        files: {
          '<%= _templates %>/magi/searxng-wordmark.min.svg': '<%= _brand %>/searxng-wordmark.svg',
    ...
    svg2jinja: {
      all: {
        ...
        dest: '../../../templates/magi/icons.html',
      },
    },
  });
  ...
  grunt.registerMultiTask('svg2jinja', 'Create Jinja2 macro', function () {
    ...
    const template = `{# this file was generated by searx/static/themes/magi/gruntfile.js #}
{%- set icons = {
