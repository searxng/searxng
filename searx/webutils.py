...
exception_classname_to_text = {
    ...
    'httpx2.TimeoutException': timeout_text,
    'httpx2.ConnectTimeout': timeout_text,
    'httpx2.ReadTimeout': timeout_text,
    'httpx2.WriteTimeout': timeout_text,
    'httpx2.HTTPStatusError': gettext('HTTP error'),
    'httpx2.ConnectError': gettext("HTTP connection error"),
    'httpx2.RemoteProtocolError': http_protocol_error_text,
    'httpx2.LocalProtocolError': http_protocol_error_text,
    'httpx2.ProtocolError': http_protocol_error_text,
    'httpx2.ReadError': network_error_text,
    'httpx2.WriteError': network_error_text,
    'httpx2.ProxyError': gettext("proxy error"),
