...
setup(
    name='zhensa',
    description="Zhensa is a metasearch engine. Users are neither tracked nor profiled.",
    ...
    entry_points={
        'console_scripts': ['zhensa-run = zhensa.webapp:run', 'zhensa-checker = zhensa.search.checker.__main__:main']
    },
