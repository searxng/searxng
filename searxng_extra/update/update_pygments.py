...
class LogicodevStyle(Style):  # pylint: disable=R0903
    """Logicodev style
    based on https://github.com/searxng/searxng/blob/2a5c39e33c3306ca17e09211fbf5a0f785cb10c8/searxng/static/themes/oscar/less/logicodev/code.less
...
def get_output_filename(relative_name):
    return join(searxng_dir, relative_name)
