...
#
# Output files: searxng/data/engines_languages.json and searxng/languages.py
...
from searxng import settings, searxng_dir
from searxng.engines import load_engines, engines
from searxng.network import set_timeout_for_thread

# Output files.
engines_languages_file = Path(searxng_dir) / 'data' / 'engines_languages.json'
languages_file = Path(searxng_dir) / 'languages.py'
