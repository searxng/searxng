...
# lint: pylint
"""
Update searxng/data/external_bangs.json using the duckduckgo bangs.
...
from searxng import searxng_dir  # pylint: disable=E0401 C0413
...
def get_bangs_filename():
    return join(join(searxng_dir, "data"), "external_bangs.json")
